FILES = ./build/kernel.asm.o ./build/kernel.o ./build/idt/idt.asm.o ./build/idt/idt.o ./build/memory/memory.o ./build/memory/heap.o ./build/memory/kheap.o ./build/io/io.asm.o ./build/memory/paging.o ./build/memory/paging.asm.o
INCLUDES = -I./src
